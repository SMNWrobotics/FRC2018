...
public class ADIS16448_IMU extends GyroBase implements Gyro, PIDSource {
  ...
  private static final double kCalibrationSampleTime = 3.0; //originally set to 5.0
...
//    Robot.gyroValid = true;
  ...
  public void calibrate() {
	  calibrate( kCalibrationSampleTime );
  }
  
  public void calibrate( double calibrationSampleTime ) {
    ...
    System.out.println( "Calibration elapsed time = " + (end - start) );
    ...
    synchronized (this) {
      ...
      System.out.println( "m_gyro_offset_x = " + m_gyro_offset_x );
      System.out.println( "m_gyro_offset_y = " + m_gyro_offset_y );
      System.out.println( "m_gyro_offset_z = " + m_gyro_offset_z );
    }
  }
